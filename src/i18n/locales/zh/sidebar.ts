...
const sidebar = {
  ...
  sidebar: {
    ...
    sharedCliHint: "引擎可切换",
    nativeCliHint: "引擎固定",
    sharedCliHelp: "多个 CLI 接入同一份对话上下文，中途可切换引擎继续聊",
    nativeCliHelp: "每个会话绑定单一引擎，上下文独立互不共享",
    providerChoiceHelp: "选中后记住，新建会话默认使用该供应商；「跟随全局配置」随启动配置联动，「独立配置」互不影响。可在 设置 → CLI配置管理 → 供应商渠道 维护",
    ...
    workspaceAliasDialogSubtitle: "原项目名：<code>{{name}}</code>",
    ...
    loadingWorkspaceSessionsIndex: "正在读取会话索引…",
    loadingWorkspaceSessionsDeep: "正在完整扫描本地会话…",

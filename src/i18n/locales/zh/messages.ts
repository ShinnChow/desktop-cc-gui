...
const messages = {
  messages: {
    ...
    backgroundTaskCardTitle: "后台任务",
    backgroundTaskCardTitleNamed: "后台任务 · {{name}}",
    backgroundTaskCardRunning: "运行中",
    backgroundTaskCardCompleted: "已完成",
    backgroundTaskCardFailed: "已失败",
    backgroundTaskCardKilled: "已取消",
    backgroundTaskCardDuration: "耗时 {{duration}}",
    backgroundTaskCardViewLog: "查看日志",

...
const messages = {
  messages: {
    ...
    backgroundTaskCardTitle: "Background task",
    backgroundTaskCardTitleNamed: "Background task · {{name}}",
    backgroundTaskCardRunning: "Running",
    backgroundTaskCardCompleted: "Completed",
    backgroundTaskCardFailed: "Failed",
    backgroundTaskCardKilled: "Killed",
    backgroundTaskCardDuration: "took {{duration}}",
    backgroundTaskCardViewLog: "View log",
    backgroundTaskCardFieldTool: "tool",
    backgroundTaskCardFieldTaskId: "task-id",
    backgroundTaskCardFieldCommand: "command",
    backgroundTaskCardFieldStatus: "status",
    backgroundTaskCardFieldExitCode: "exit-code",
    backgroundTaskCardFieldOutput: "output-file",
    backgroundTaskCardFieldError: "error",
    backgroundTaskCardFieldLog: "log",
  },
};

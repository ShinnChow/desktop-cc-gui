...
export const OMP_SESSION_CACHE_TTL_MS = 60_000;
export const OMP_SESSION_FETCH_TIMEOUT_MS = SIDEBAR_THREAD_LIST_TIMEOUT_MS;
export const QODER_SESSION_CACHE_TTL_MS = 60_000;
export const QODER_SESSION_FETCH_TIMEOUT_MS = SIDEBAR_THREAD_LIST_TIMEOUT_MS;

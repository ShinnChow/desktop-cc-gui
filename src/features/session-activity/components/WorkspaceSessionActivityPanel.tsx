...
import {
  buildHeaderSummary,
  buildTurnArtifactSummary,
  buildTurnValidationEvidence,
  canExpandEvent,
  countTurnArtifactFiles,
  countVisibleActivityItems,
  emitSoloFollowMetric,
  formatActivityTime,
  focusRovingTab,
  formatSignedCount,
  isPlaceholderCommandText,
  getCollapsedCommandSummary,
  readSoloFollowCoachDismissedByWorkspace,
  readSoloFollowFeatureFlag,
  resolveChildSessionPillLabel,
  resolveFollowNudgeTurnKey,
  resolveSessionPillStyle,
  shouldAutoExpandRunningEvent,
  sortTurnGroupEvents,
  writeSoloFollowCoachDismissedByWorkspace,
  MAX_STICKY_CHILD_SESSION_COUNT,
  FOLLOW_BUBBLE_AUTO_DISMISS_MS,
  REASONING_FOLLOW_PAUSE_THRESHOLD_PX,
  RUNNING_CARD_MIN_EXPANDED_MS,
  MAX_VISIBLE_STICKY_CHILD_SESSION_SUMMARIES,
  SOLO_FOLLOW_DISCOVERY_COACH_FLAG_KEY,
  SOLO_FOLLOW_DISCOVERY_NUDGE_FLAG_KEY,
  type ActivityTab,
  type FollowBubbleGeometry,
  type FollowNudgeContext,
  type SemanticSummarySectionKey,
  type SessionActivityTurnGroup,
  type StickyChildSessionSummary,
  type TurnArtifactTab,
} from "./activityPanelHelpers";

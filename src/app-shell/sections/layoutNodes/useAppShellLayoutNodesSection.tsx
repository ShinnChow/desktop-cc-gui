...
import { buildLayoutNodesChromeOptions } from "./layoutNodesOptionsChrome";
import { buildLayoutNodesComposerOptions } from "./layoutNodesOptionsComposer";
import { buildLayoutNodesEditorOptions } from "./layoutNodesOptionsEditor";
import { buildLayoutNodesGitOptions } from "./layoutNodesOptionsGit";
import { buildLayoutNodesPanelsOptions } from "./layoutNodesOptionsPanels";
import { buildLayoutNodesRuntimeOptions } from "./layoutNodesOptionsRuntime";
import { buildLayoutNodesWorkspaceOptions } from "./layoutNodesOptionsWorkspace";
import {
...
export function useAppShellLayoutNodesSection(
  ...
  const {
    ...
    workspace: buildLayoutNodesWorkspaceOptions({
      workspaces, groupedWorkspaces, workspaceGroups, deletingWorktreeIds,
      threadsByWorkspace, threadParentById, threadStatusById,
      historyLoadingByThreadId, historyLoadingProgressByThreadId,
      historyRestoredAtMsByThread, runningSessionCountByWorkspaceId,
      recentCompletedSessionCountByWorkspaceId, hydratedThreadListWorkspaceIds,
      threadListLoadingByWorkspace, threadListPagingByWorkspace,
      threadListCursorByWorkspace, activeWorkspaceId, activeThreadId, isPhone,
      isTablet, appSettings, handleUpdateSystemProxy,
    }),
    runtime: buildLayoutNodesRuntimeOptions({
      activeItems, activeQueuedHandoffBubble, threadItemsByThread,
      sessionRadarRunningSessions, sessionRadarRecentCompletedSessions,
      activeRateLimits, appSettings, handleChangeDefaultVisibleThreadRootCount,
      handleRefreshAccountRateLimits, activeAccount, handleSwitchAccount,
      handleCancelSwitchAccount, accountSwitching, openAppIconById,
      handleSelectOpenAppId, approvals, userInputRequests,
      handleApprovalDecision, handleApprovalBatchAccept, handleApprovalRemember,
      handleUserInputSubmitWithPlanApply, handleUserInputDismiss,
      handleRecoverThreadRuntime, handleRecoverThreadRuntimeAndResend,
      handleThreadRecoveryFork, handleExitPlanModeExecute,
    }),
    chrome: buildLayoutNodesChromeOptions({
      handleOpenSettings, handleOpenSessionManagement,
      handleOpenShortcutsSettings, handleOpenAgentSettings,
      handleOpenPromptSettings, handleOpenModelSettings, handleOpenCliSettings,
      handleRefreshModelConfig, isModelConfigRefreshing,
      handleOpenSkillsSettings, handleDebugClick, showDebugButton,
      handleAddWorkspace, handleSelectHome, handleSelectWorkspace,
      handleReorderWorkspaces, handleConnectWorkspace, handleAddAgent,
      availableEngines, refreshEngines, handleStartSharedConversation,
      handleAddWorktreeAgent, handleAddCloneAgent,
      handleToggleWorkspaceCollapse, handleSelectThread,
      handleClearActiveThread, handleProviderContinuationTargetReady,
      handleSelectHomeWorkspace, handleDeleteThread, handleArchiveThread,
      deleteThreadPrompt, isDeleteThreadPromptBusy,
      handleDeleteThreadPromptCancel, handleConfirmDeleteConfirm, renamePrompt,
      handleRenamePromptChange, handleRenamePromptCancel,
      handleRenamePromptConfirm, handleSyncThread, pinThread, unpinThread,
      isThreadPinned, getPinTimestamp, pinnedThreadsVersion, isThreadAutoNaming,
      handleSidebarRenameThread, handleAutoNameThread, handleOpenClaudeTui,
      handleDeleteWorkspace, handleDeleteWorktree, handleRenameWorkspaceAlias,
      workspaceGroups, assignWorkspaceGroup, handleLoadOlderThreads,
      handleQuickReloadWorkspaceThreads, handleReloadWorkspaceThreads,
      isExitedSessionsHidden, toggleExitedSessionsHidden,
      rootSessionFolderDraftRequestByWorkspaceId,
      onRequestRootSessionFolderDraft, updaterState, startUpdate, dismissUpdate,
      errorToasts, dismissErrorToast, handleOpenSpecHub,
      showLoadingProgressDialog, hideLoadingProgressDialog, activeWorkspace,
      activeParentWorkspace, worktreeLabel, worktreeRename, isWorktreeWorkspace,
      gitStatus, branches, branchError, currentBranch, localBranches,
      remoteBranches, repositories, repositoriesLoading, repositoryError,
      selectedRepositoryRoot, selectRepository, handleCheckoutBranch,
      handleCreateBranch, handleUpdateBranch, handleUpdateAllRepositories,
      handleCheckoutAllRepositories, handleLoadCommonRepositoryBranches,
      handleCopyThread, handleLockPanel, handleToggleTerminalPanel, isCompact,
      launchScriptState, launchScriptsState, mainHeaderActions, filePanelMode,
      setFilePanelMode, liveEditPreviewEnabled, handleToggleLiveEditPreview,
      isFilesLoading, fileTreeLoadError, refreshFiles,
      handleOpenDetachedFileExplorer, handleToggleRuntimeConsole,
      runtimeRunState, browserDockOpen, handleCloseBrowserDock,
    }),
    editor: buildLayoutNodesEditorOptions({
      centerMode, setCenterMode, fileCompareSession, handleOpenFileHistory,
      editorSplitCompanion, setEditorSplitCompanion, editorSplitLayout,
      handleToggleEditorSplitLayout, isEditorFileMaximized,
      handleToggleEditorFileMaximized, activeEditorFilePath,
      editorNavigationTarget, editorHighlightTarget, openFileTabs,
      handleActivateWorkspaceFileTab, handleCloseWorkspaceFileTab,
      handleCloseOtherWorkspaceFileTabs, handleCloseAllWorkspaceFileTabs,
      handleReorderWorkspaceFileTabs, setActiveEditorLineRange,
      handleOpenWorkspaceFile, handleOpenWorkspaceFileCompare,
      handleCloseFileCompare, enableMainFileExternalChangeMonitoring,
      mainFileExternalChangeTransportMode, liveEditPreviewEnabled,
      handleExitWorkspaceEditor, handleExitDiff, activeTab, setActiveTab,
      tabletTab, gitPanelMode, handleGitPanelModeChange,
      handleOpenGitHistoryPanel, handleOpenProjectMap, gitDiffViewStyle,
      gitDiffListView, setGitDiffListView, t, activeParentWorkspace,
      isWorktreeWorkspace, worktreeApplyLoading, worktreeApplyError,
      worktreeApplySuccess, handleApplyWorktreeChanges,
    }),
    git: buildLayoutNodesGitOptions({
      gitStatus, fileStatus, selectedDiffPath, diffScrollRequestId,
      handleSelectDiffForPanel, gitLogEntries, gitLogTotal, gitLogAhead,
      gitLogBehind, gitLogAheadEntries, gitLogBehindEntries, gitLogUpstream,
      gitLogError, gitLogLoading, selectedCommitSha, gitIssues, gitIssuesTotal,
      gitIssuesLoading, gitIssuesError, gitPullRequests, gitPullRequestsTotal,
      gitPullRequestsLoading, gitPullRequestsError, selectedPullRequest,
      diffSource, gitPullRequestComments, gitPullRequestCommentsLoading,
      gitPullRequestCommentsError, handleGitSelectPullRequest,
      handleGitSelectCommit, gitRemoteUrl, activeGitRoot, gitRootCandidates,
      gitRootScanDepth, gitRootScanLoading, gitRootScanError,
      gitRootScanHasScanned, setGitRootScanDepth, scanGitRoots,
      handleSelectGitRoot, handleClearGitRoot, handlePickGitRoot,
      handleStageGitAll, handleStageGitFile, handleUnstageGitAll,
      handleUnstageGitFile, handleUnstageGitPaths, handleRevertGitFile,
      handleRevertGitPaths, handleRevertAllGitChanges, activeDiffs,
      activeDiffLoading, activeDiffError, refreshGitLog, refreshGitDiffs,
      handleManualGitStatusRefresh, handleActiveDiffPath, setGitDiffViewStyle,
      commitMessage, commitMessageLoading, commitMessageError,
      handleCommitMessageChange, handleGenerateCommitMessage, handleCommit,
      handleCommitAndPush, handleCommitAndSync, handlePush, handleSync,
      commitLoading, pushLoading, syncLoading, commitError, pushError,
      syncError, isMultiRepository, repositoryStatuses,
      repositoryStatusesLoading, refreshRepositoryStatuses,
      handleStageRepositoryFile, handleUnstageRepositoryFile,
      handleUnstageRepositoryAll, handleUnstageRepositoryFiles,
      handleRevertRepositoryFile, handleRevertRepositoryFiles,
      handleStageRepositoryAll, handleCommitRepositories,
      repositoryCommitSummary,
    }),
    composer: buildLayoutNodesComposerOptions({
      handleSendPrompt, handleSendPromptToNewAgent, handleCreatePrompt,
      handleUpdatePrompt, handleDeletePrompt, handleMovePrompt,
      handleRevealWorkspacePrompts, handleRevealGeneralPrompts, activeWorkspace,
      handleComposerSendWithIntentCanvas, handleComposerQueueWithIntentCanvas,
      handleRequestContextCompaction, interruptTurn, activeThreadId,
      isSharedSessionThreadId, completionEmailIntentByThread,
      handleToggleCompletionEmail, handleRewindFromMessage,
      handleForkFromMessage, canInterrupt, isReviewing, isProcessing,
      appSettings, reviewPrompt, closeReviewPrompt, showPresetStep,
      choosePreset, highlightedPresetIndex, setHighlightedPresetIndex,
      highlightedBranchIndex, setHighlightedBranchIndex, highlightedCommitIndex,
      setHighlightedCommitIndex, handleReviewPromptKeyDown, selectBranch,
      selectBranchAtIndex, confirmBranch, selectCommit, selectCommitAtIndex,
      confirmCommit, updateCustomInstructions, confirmCustom, activeTokenUsage,
      activeEngine, handleCodexAutoCompactionSettingsChange, activeQueue,
      handleDraftChange, activeImages, pickImages, attachImages, removeImage,
      prefillDraft, handlePrefillHandled, composerInsert, handleInsertHandled,
      handleEditQueued, handleDeleteQueued, handleFuseQueued,
      canFuseActiveQueue, fuseDisabledReasonKey, activeFusingMessageId,
      collaborationModes, collaborationModesEnabled,
      selectedCollaborationModeId, applySelectedCollaborationMode,
      availableEngines, handleSelectConversationEngine, effectiveModels,
      providerModelCatalogs, effectiveSelectedModelId,
      projectMapDatasetController, handleSelectModel, intentCanvasOpenRequest,
      handleOpenIntentCanvas, handleIntentCanvasOpenRequestConsumed,
      handleAttachIntentCanvasToThread, pendingIntentCanvasDocuments,
      handleRemovePendingIntentCanvas, reasoningOptions, selectedEffort,
      setSelectedEffort, claudeThinkingVisible,
      handleResolvedClaudeThinkingVisibleChange, effectiveReasoningSupported,
      openCodeAgents, selectedOpenCodeAgent, handleSelectOpenCodeAgent,
      selectedAgent, handleSelectAgent, OPENCODE_VARIANT_OPTIONS,
      selectedOpenCodeVariant, handleSelectOpenCodeVariant, accessMode,
      handleSetAccessMode, skills, EMPTY_STRING_ARRAY, prompts, commands, files,
      directories, directoryMetadata, fileTreeSourceVersion, gitignoredFiles,
      gitignoredDirectories, handleInsertComposerText, composerInputRef,
      composerEditorSettings, formatShortcutLabelOrNull, textareaHeight,
      onTextareaHeightChange, handleOpenExperimentalSettings, composerSendLabel,
      activeEditorFilePath, activeEditorLineRange,
      activeIntentCanvasCodeSelectionAnchor,
      setActiveIntentCanvasCodeSelectionAnchor, fileReferenceMode,
      setFileReferenceMode,
    }),
    panels: buildLayoutNodesPanelsOptions({
      showComposer, activePlan, isPlanMode, openPlanPanel, closePlanPanel,
      isPlanPanelDismissed, agentTaskScrollRequest,
      handleSelectStatusPanelSubagent, debugEntries, debugOpen, terminalOpen,
      terminalTabs, activeTerminalId, onSelectTerminal, onNewTerminal,
      onCloseTerminal, terminalState, clearDebugEntries, handleCopyDebug,
      onDebugPanelResizeStart, onTerminalPanelResizeStart, handleBackFromDiff,
      handleGoProjects, workspaceDropTargetRef, dropOverlayActive,
      dropOverlayText, handleWorkspaceDragOver, handleWorkspaceDragEnter,
      handleWorkspaceDragLeave, handleWorkspaceDrop, appMode,
      handleAppModeChange, handleOpenHomeChat, handleOpenMemory,
      handleOpenProjectMemory, handleOpenReleaseNotes, focusedProjectMemoryId,
      focusedProjectMemoryRequestKey, focusedWorkspaceNoteId,
      focusedWorkspaceNoteRequestKey, handleOpenSearchPalette,
      handleOpenQuickSwitcher, collapseSidebar, appSettings,
      handleOpenWorkspaceHome,
    }),
  });

// react-i18next test translations + interpolation helper, extracted verbatim
// from vitest.setup.ts. Consumed by the vi.mock("react-i18next") factory in
// vitest.setup.ts via a lazy `await import(...)` (vi.mock hoisting-safe).
export const mockTranslate = (key: string, params?: Record<string, unknown>) => {
      ...
      const translations: Record<string, string> = {
        ...
        "settings.workspaceWallpaperCustom": "Custom background",
        "settings.workspaceWallpaperChoose": "Choose wallpaper",
        "settings.workspaceWallpaperCurrent": "Current wallpaper",
        ...
        "settings.workspaceWallpaperRotationHint":
          "Add at least two visible wallpapers to the library to rotate them.",
        "settings.workspaceWallpaperPickerTitle": "Choose wallpaper",
        "settings.workspaceWallpaperPickerDesc":
          "Pick from your library, or browse the wallpaper market and download one.",
        "settings.workspaceWallpaperPickerTabs": "Wallpaper source",
        "settings.workspaceWallpaperTab_library": "My library",
        "settings.workspaceWallpaperTab_market": "Market",
        "settings.workspaceWallpaperMarketSearch": "Search wallpapers",
        "settings.workspaceWallpaperMarketCategory": "Category",
        "settings.workspaceWallpaperMarketCategory_all": "All",
        "settings.workspaceWallpaperMarketCategory_general": "General",
        "settings.workspaceWallpaperMarketCategory_anime": "Anime",
        "settings.workspaceWallpaperMarketCategory_people": "People",
        "settings.workspaceWallpaperMarketLoading": "Loading the market…",
        "settings.workspaceWallpaperMarketEmpty":
          "No wallpapers found. Try another search.",
        "settings.workspaceWallpaperMarketFailed":
          "The wallpaper market is unavailable right now.",
        "settings.workspaceWallpaperMarketRetry": "Retry",
        "settings.workspaceWallpaperMarketPrev": "Previous",
        "settings.workspaceWallpaperMarketNext": "Next",
        "settings.workspaceWallpaperMarketPage": "Page {{page}} / {{last}}",
        "settings.workspaceWallpaperDownload": "Download {{name}}",
        "settings.workspaceWallpaperDownloadAction": "Download",
        "settings.workspaceWallpaperDownloading": "Downloading…",
        "settings.workspaceWallpaperDownloadFailed":
          "Could not download the wallpaper.",
        "settings.workspaceWallpaperInLibrary": "In library",
        "settings.workspaceWallpaperImport": "Import",
        "settings.workspaceWallpaperImporting": "Importing…",
        "settings.workspaceWallpaperImportFailed":
          "Could not import the wallpaper.",
        "settings.workspaceWallpaperLibraryEmpty":
          "No wallpapers yet. Import a local image or MP4.",
        "settings.workspaceWallpaperHiddenEmpty": "No hidden wallpapers.",
        "settings.workspaceWallpaperShowHidden": "Hidden ({{count}})",
        "settings.workspaceWallpaperShowVisible": "Show library",
        "settings.workspaceWallpaperHide": "Hide",
        "settings.workspaceWallpaperRestore": "Restore",
        "settings.workspaceWallpaperRemove": "Remove",
        "settings.workspaceWallpaperFilter": "Type",
        "settings.workspaceWallpaperFilter_all": "All",
        "settings.workspaceWallpaperFilter_image": "Images",
        "settings.workspaceWallpaperFilter_video": "Videos",
        "settings.workspaceWallpaperKind_image": "Image",
        "settings.workspaceWallpaperKind_video": "Video",
        "settings.workspaceWallpaperPlay": "Play",
        "settings.workspaceWallpaperPause": "Pause",
        "settings.workspaceWallpaperFit": "Fit",
        "settings.workspaceWallpaperFit_cover": "Cover",
        "settings.workspaceWallpaperFit_contain": "Contain",
        "settings.workspaceWallpaperFit_center": "Center",
        "settings.workspaceWallpaperFit_fill": "Stretch",
        "settings.workspaceWallpaperSpeed": "Speed",
        "settings.workspaceWallpaperSpeedValue": "{{value}}x",
        "settings.workspaceWallpaperFlip": "Flip horizontally",
        "settings.workspaceWallpaperBlur": "Wallpaper blur",
        "settings.workspaceWallpaperBlurValue": "{{value}}px",
        "settings.workspaceWallpaperDarken": "Darken",
        "settings.workspaceWallpaperDarkenValue": "{{value}}%",
        "settings.workspaceWallpaperRotation": "Auto rotate",
        "settings.workspaceWallpaperRotationInterval": "Interval",
        "settings.workspaceWallpaperRotationValue": "{{value}} min",
        ...
        "settings.minimalTranscript": "Minimal Transcript",
        "settings.minimalTranscriptDesc": "Minimal transcript description",
        "settings.minimalTranscriptNormal": "Normal",
        "settings.minimalTranscriptMinimal": "Minimal",
        "settings.topSessionTabsHide": "Hide top tabs",
        "settings.topSessionTabsShow": "Show top tabs",
        ...
        "messages.middleStepsStatNarration": "叙述 {{count}} 段",
        "messages.middleStepsProcessedAria": "{{state}}过程摘要：{{detail}}",
        "messages.backgroundTaskCardTitle": "Background task",
        "messages.backgroundTaskCardTitleNamed": "Background task · {{name}}",
        "messages.backgroundTaskCardRunning": "Running",
        "messages.backgroundTaskCardCompleted": "Completed",
        "messages.backgroundTaskCardFailed": "Failed",
        "messages.backgroundTaskCardKilled": "Killed",
        "messages.backgroundTaskCardDuration": "took {{duration}}",
        "messages.backgroundTaskCardViewLog": "View log",
        "messages.backgroundTaskCardFieldTool": "tool",
        "messages.backgroundTaskCardFieldTaskId": "task-id",
        "messages.backgroundTaskCardFieldCommand": "command",
        "messages.backgroundTaskCardFieldStatus": "status",
        "messages.backgroundTaskCardFieldExitCode": "exit-code",
        ...
        "composer.runStatus.bgLogLoading": "Loading log…",
        "composer.runStatus.bgLogError": "Log temporarily unavailable",
        "composer.runStatus.bgLogEmpty": "(empty log)",
        "composer.runStatus.bgLogTruncated": "tail only (log too long)",

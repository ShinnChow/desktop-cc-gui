...
#[path = "cc_gui_daemon/state.rs"]
mod state;
#[path = "cc_gui_daemon/event_sink.rs"]
mod event_sink;
#[path = "cc_gui_daemon/remote_backend.rs"]
mod remote_backend;
#[allow(dead_code)]
...
#[path = "../runtime/mod.rs"]
mod runtime;
#[path = "cc_gui_daemon/session_index.rs"]
mod session_index;
...
#[path = "cc_gui_daemon/shared_sessions.rs"]
mod shared_sessions;
#[allow(dead_code)]
...
#[path = "cc_gui_daemon/codex.rs"]
mod codex;

#[path = "cc_gui_daemon/files.rs"]
mod files;
